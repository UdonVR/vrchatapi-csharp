...
namespace VRChat.API.Model
{
    ...
    public partial class APIConfig : IEquatable<APIConfig>, IValidatableObject
    {
        ...
        /// <param name="homepageRedirectTarget">Redirect target if you try to open the base API domain in your browser (required) (default to &quot;https://hello.vrchat.cloud&quot;).</param>
        /// <param name="hubWorldId">WorldID be \&quot;offline\&quot; on User profiles if you are not friends with that user. (required).</param>
        /// <param name="imageHostUrlList">A list of explicitly allowed origins that worlds can request images from via the Udon&#39;s [VRCImageDownloader#DownloadImage](https://creators.vrchat.cloud/worlds/udon/image-loading/#downloadimage). (required).</param>
        ...
        /// <param name="stringHostUrlList">A list of explicitly allowed origins that worlds can request strings from via the Udon&#39;s [VRCStringDownloader.LoadUrl](https://creators.vrchat.cloud/worlds/udon/string-loading/#ivrcstringdownload). (required).</param>
        ...
        /// <summary>
        /// A list of explicitly allowed origins that worlds can request images from via the Udon&#39;s [VRCImageDownloader#DownloadImage](https://creators.vrchat.cloud/worlds/udon/image-loading/#downloadimage).
        /// </summary>
        /// <value>A list of explicitly allowed origins that worlds can request images from via the Udon&#39;s [VRCImageDownloader#DownloadImage](https://creators.vrchat.cloud/worlds/udon/image-loading/#downloadimage).</value>
        ...
        /// <summary>
        /// A list of explicitly allowed origins that worlds can request strings from via the Udon&#39;s [VRCStringDownloader.LoadUrl](https://creators.vrchat.cloud/worlds/udon/string-loading/#ivrcstringdownload).
        /// </summary>
        /// <value>A list of explicitly allowed origins that worlds can request strings from via the Udon&#39;s [VRCStringDownloader.LoadUrl](https://creators.vrchat.cloud/worlds/udon/string-loading/#ivrcstringdownload).</value>
