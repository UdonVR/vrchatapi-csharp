...
namespace VRChat.API.Model
{
    ...
    public partial class CurrentUserPresence : IEquatable<CurrentUserPresence>, IValidatableObject
    {
        ...
        public CurrentUserPresence(string avatarThumbnail = default(string), List<string> currentAvatarTags = default(List<string>), string displayName = default(string), string debugflag = default(string), List<string> groups = default(List<string>), string id = default(string), string instance = default(string), string instanceType = default(string), string isRejoining = default(string), string platform = default(string), string profilePicOverride = default(string), string status = default(string), string travelingToInstance = default(string), string travelingToWorld = default(string), string userIcon = default(string), string world = default(string))
        {
